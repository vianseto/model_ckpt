...
avatar_dir = "/data/server_stable/avatar"

def wav2lip_gan(face_path, audio_path, output_path):
    torch.cuda.empty_cache()
    os.system(f"python /media/botika/eef58538-68b7-42bd-a60c-73abbba6834a/home/botika/vian/Wav2Lip/inference.py --checkpoint_path /media/botika/eef58538-68b7-42bd-a60c-73abbba6834a/home/botika/vian/Wav2Lip/checkpoints/wav2lip_gan.pth --face={face_path} --audio={audio_path} --outfile={output_path} --nosmooth --fps=30")

def real_esrgan_video(video_path, output_path, scale):
    torch.cuda.empty_cache()
    os.system(f"python /media/botika/eef58538-68b7-42bd-a60c-73abbba6834a/home/botika/vian/Real-ESRGANinference_realesrgan_video.py -n RealESRGAN_x4plus -i={video_path} -o={output_path} --outscale={scale} --face_enhance --fps 30")
...
def botika_tts(text,type,id_dir,filename):
    ...
    os.system(f"sudo wget {link} -O {save_path}")
    return save_path
            ...
            try:
                ...
                if enhance:
                    ...
                    try:
                        ...
                        os.system(f"sudo mv -f {old_file_name} {new_file_name}")
                    except:
...
if __name__ == '__main__':
    app.run(threaded=False, processes=2, host='0.0.0.0', port='8000')